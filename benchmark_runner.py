...
SOLIDIFI_CATEGORY_MAP: Dict[str, Optional[str]] = {
    ...
    "Unhandled-Exceptions": "unchecked_return",
...
DETECTOR_MODULES: List[Tuple[str, str]] = [
    ...
    ("detectors.tod_detector", "TODDetector"),
    ("detectors.txorigin_detector",         "TxOriginDetector"),
    ("detectors.timestamp_detector",        "TimestampDetector"),   # FIX v1.2.0
...
_ALIASES: Dict[str, Set[str]] = {
    "arithmetic_overflow":  {"arithmetic_overflow", "integer_overflow", "overflow_underflow", "arithmetic_issue"},
    "integer_overflow":     {"integer_overflow", "arithmetic_overflow", "overflow_underflow", "arithmetic_issue"},
